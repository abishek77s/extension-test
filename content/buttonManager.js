...
const buttonManager = {
  createGenerateButton(text, contentType) {
    ...
    button.innerHTML = `
      <svg class='icon' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 54 60">
  ...
  createEnhanceButton(text, contentType) {
    ...
    button.innerHTML = `
     <svg class='icon' xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 77 66">
  ...
  createRegenerateButton(text, contentType) {
    ...
    <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 54 60">
